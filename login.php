...
<head>
    ...
    <title>Upoważnienia 1.0 | Logowanie</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="login.php"><b>Upoważnienia</b><?php echo $nr_wersji_programu; ?></a>
    </div><!-- /.login-logo -->
...
?>
    ...
    ?>
        ...
        <a href="#" title="Zadzwoń na 79 11075 ">Nie pamiętam hasła</a><br>
