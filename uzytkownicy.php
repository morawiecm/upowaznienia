...
<div class="content-wrapper">
    ...
    if (isset($_POST['przycisk_zmien_haslo'])) {
        ...
        echo "<table class='table'><form name='edycja_hasla' method='post' action='uzytkownicy.php?a=zmien_haslo'>";
            ...
            <div class="box-body">';
...

                {
                    ...
                    <tr><th>Typ osoby:</th><td><select name='typ_osoby' class='form-control'>";
                                ...
                                {
                                    echo"<option value='0'>Pracownik</option>";
                                }
                                else{
                                    echo "<option value='1'>Funkcjonariusz</option>";
                                }
                                echo"<option value='0'>Pracownik</option><option value='1'>Funkcjonariusz</option></select>
